...
85 Stamp out the demons of complexity (Part 2) 85.1 Eliminate clutter. 85.2 Avoid bitwise masks; use bit fields 85.3 Don't use done flags 85.4 Assume that your reader knows C 85.5 Don't pretend that C supports a Boolean type (#define TRUE) 86 1-bit bit fields should be unsigned 87 Pointers must be above the base address of an array 88 Use pointers instead of array indexes 89 Avoid goto except . . .
